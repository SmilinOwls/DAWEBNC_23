...
import { activateUser, registerUser } from "../../Actions/AuthAction";
...
function Signup(props) {
  ...
  const handleConfirm = (value) => {
    ...
    const data = {
      email: value.email,
      activatedNumber: value.activatedNumber,
    };
    console.log(data);
          ...
          >
            {({ errors, touched }) => (
              <Form>
                ...
                <p>
                  A verfication link has been sent to your registered email.
                  Please check it out for the activation code
                </p>
                <div className="form-holder">
                  <Field
                    name="email"
                ...
                <div className="form-holder">
                  <Field
                    ...
                    className={
                      "reset-form-control" +
                      (errors.activatedNumber && touched.activatedNumber
                        ? " is-invalid"
                        : "")
                    }
                    placeholder="Input activated number"
                    onKeyUp={handleChange}
                  />
